  ...
  return <SiteShell><Seo exactTitle title="Free Online Image Converter – RAW, PNG, JPG, PDF & PSD" description="Free online image converter for PNG, JPG, PDF, PSD, WebP and supported RAW files. Convert images privately in your browser with no upload or sign-up." keywords="free online image converter, convert images online, free image converter, RAW to JPG, PNG to JPG, no upload, private converter, batch converter"/><main>
    <section className="relative overflow-hidden bg-[#132432] text-[#f4f0e8]">
      ...
      <div className="relative mx-auto max-w-[1440px] px-5 pb-16 pt-14 lg:px-10 lg:pb-24 lg:pt-20"><div className="max-w-3xl">
        ...
        <h1 className="font-display max-w-5xl text-4xl font-bold leading-[.93] tracking-[-.075em] sm:text-5xl lg:text-7xl">Free Online Image Converter <span className="block"><i className="mr-3 inline-block h-[.7em] w-[.18em] bg-[#b7f840] not-italic"/>Convert RAW, PNG, JPG, PDF &amp; PSD</span></h1>
...
function GuideCard({ title, copy }: { title: string; copy: string }) { return <article className="bg-[#f7f4ee] p-5"><h3 className="font-display text-lg font-bold tracking-[-.04em]">{title}</h3><p className="mt-2 text-sm leading-6 text-[#52616a]">{copy}</p></article>; }
const faqItems = [
