...
const homepageSchema = { "@context": "https://schema.org", "@graph": [
  { "@type": "SoftwareApplication", "@id": "https://convertanyimage.com/#app", name: "Convert Any Image", url: "https://convertanyimage.com/", applicationCategory: "MultimediaApplication", operatingSystem: "Any", provider: { "@id": "https://convertanyimage.com/#organization" }, description: "Browser-based image conversion and compression for supported formats, including HEIC-to-JPG and WebP-to-PNG workflows. Create separate output copies without a standard upload step, account or watermark.", featureList: ["Watermark-free output", "Batch conversion for supported files", "Preserve existing PNG transparency when exporting to PNG", "Local browser processing for supported formats", "No account required"], isAccessibleForFree: true, offers: { "@type": "Offer", price: "0", priceCurrency: "USD" } },
  { "@type": "FAQPage", "@id": "https://convertanyimage.com/#faq", mainEntity: faqItems.map((faq) => ({ "@type": "Question", name: faq.question, acceptedAnswer: { "@type": "Answer", text: faq.answer } })) },
  { "@type": "WebPage", "@id": "https://convertanyimage.com/#webpage", url: "https://convertanyimage.com/", name: "Free Online Image Converter – RAW, PNG, JPG, PDF & PSD", author: { "@type": "Organization", "@id": "https://convertanyimage.com/#organization", name: "Convert Any Image Editorial Team", url: "https://convertanyimage.com/about" }, publisher: { "@type": "Organization", "@id": "https://convertanyimage.com/#organization", name: "Convert Any Image" }, datePublished: "2026-08-27T00:00:00+02:00", dateModified: "2026-08-27T00:00:00+02:00", citation: ["https://www.cipa.jp/e/std/std-sec.html", "https://www.loc.gov/preservation/digital/formats/fdd/fdd000618.shtml"] },
] };
