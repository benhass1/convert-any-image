...
function ToolCta({ compact = false, tool = "convert" }: { compact?: boolean; tool?: Article["tool"] }) {
  const href = tool === "compress" ? "/compress#compress-upload" : tool === "exif" ? "/remove-exif#exif-upload" : "/#converter-upload";
