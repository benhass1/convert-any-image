...
const configurations: Record<Variant, FormatPageConfig> = {
  ...
  webp: {
    ...
    sections: [
      ...
      { heading: "How to Convert WebP to PNG for Shopify Transparent Backgrounds", paragraphs: ["Open the image converter, select the WebP file and choose PNG. The downloaded file is a new PNG copy that you can inspect before putting it into a product-image workflow.", "A compatible conversion can preserve existing transparent pixels, but it does not remove an opaque background or create a cutout. Review the PNG against a contrasting background to confirm what the source contained."] },
